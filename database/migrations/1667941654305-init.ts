...
class Init1667941654305 implements MigrationInterface {

    public name = 'Init1667941654305'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('CREATE TABLE "moulinette_source" ("id" SERIAL NOT NULL, "majorVersion" integer NOT NULL, "minorVersion" integer NOT NULL, "patchVersion" integer NOT NULL, "tarball" character varying NOT NULL, "checksum" character varying NOT NULL, "rules" text NOT NULL, "use" integer NOT NULL, "isDeprecated" boolean NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "moulinetteId" character varying, CONSTRAINT "PK_9bbb355c8b0f94813c6c25cda06" PRIMARY KEY ("id"))')
        ...
        await queryRunner.query('CREATE TABLE "moulinette" ("id" character varying NOT NULL, "repository" character varying NOT NULL, "isOfficial" boolean NOT NULL, "use" integer NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "projectId" character varying, CONSTRAINT "PK_b2c68b4438357bb1dbca06b38f2" PRIMARY KEY ("id"))')
        await queryRunner.query('CREATE TABLE "run" ("id" character varying NOT NULL, "suites" text NOT NULL, "moulinetteVersion" character varying NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "moulinetteId" character varying, "ownerId" character varying, CONSTRAINT "PK_804c38ffba92002c6d2c646dd46" PRIMARY KEY ("id"))')
        ...
        await queryRunner.query('ALTER TABLE "run" ADD CONSTRAINT "FK_6a4079ebc5516d9f3f6f8e699e4" FOREIGN KEY ("moulinetteId") REFERENCES "moulinette"("id") ON DELETE CASCADE ON UPDATE NO ACTION')
        await queryRunner.query('ALTER TABLE "run" ADD CONSTRAINT "FK_2caabc8e39c87be4a8dd0ed0e2b" FOREIGN KEY ("ownerId") REFERENCES "account"("id") ON DELETE CASCADE ON UPDATE NO ACTION')
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('ALTER TABLE "run" DROP CONSTRAINT "FK_2caabc8e39c87be4a8dd0ed0e2b"')
        await queryRunner.query('ALTER TABLE "run" DROP CONSTRAINT "FK_6a4079ebc5516d9f3f6f8e699e4"')
